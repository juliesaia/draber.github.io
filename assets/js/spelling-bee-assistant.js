        ...
        getSimilarWords() {
            ...
            data.getList('foundTerms').forEach(foundTerm => {
                const candidates = {
                    ...
                    levenshtein: remainders.filter(remainder => foundTerm !== remainder && jsLevenshtein(remainder, foundTerm) === 1).length,
